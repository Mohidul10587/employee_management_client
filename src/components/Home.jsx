...
const Home = () => {
  ...
  const adminRecords = () => {
    axios
      .get("https://test2.notebookprokash.com/auth/admin_records")
      .then((result) => {
  ...
  const adminCount = () => {
    axios
      .get("https://test2.notebookprokash.com/auth/admin_count")
      .then((result) => {
        if (result.data.Status) {
  ...
  const employeeCount = () => {
    axios
      .get("https://test2.notebookprokash.com/auth/employee_count")
      .then((result) => {
        if (result.data.Status) {
  ...
  const salaryCount = () => {
    axios
      .get("https://test2.notebookprokash.com/auth/salary_count")
      .then((result) => {
        if (result.data.Status) {
  ...
  const handleEditSubmit = () => {
    axios
      .put(
        `https://test2.notebookprokash.com/auth/edit_admin/${editingAdminId}`,
        {
          email: editedEmail,
        }
      )
  ...
  const handleDeleteAdmin = (id) => {
    axios
      .delete(`https://test2.notebookprokash.com/auth/delete_admin/${id}`)
      .then((result) => {
        if (result.data.success) {
