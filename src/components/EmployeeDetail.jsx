...
function EmployeeDetail() {
  ...
  useEffect(() => {
    axios
      .get(`https://test2.notebookprokash.com/employee/detail/${id}`)
      .then((result) => {
  ...
  useEffect(() => {
    if (employee) {
      axios
        .get(
          `https://test2.notebookprokash.com/employee/category/${employee.category_id}`
        )
        .then((result) => {
  ...
  const handleLogout = () => {
    ...
    axios
      .get("https://test2.notebookprokash.com/employee/logout")
      .then((result) => {
