...
const EditEmployee = () => {
  ...
  useEffect(() => {
    // Fetch categories
    axios
      .get("https://test2.notebookprokash.com/auth/category")
      .then((result) => {
    ...
    axios
      .get(`https://test2.notebookprokash.com/auth/employee/${id}`)
      .then((result) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://test2.notebookprokash.com/auth/edit_employee/${id}`,
        employee
      )
      .then((result) => {
        if (result.data.success) {
